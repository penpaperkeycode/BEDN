...
FrontLayer = [
    ...
    Binarizedconvolution2dLayer(3,4*netWidth,'Padding','same','Stride',2,'BiasLearnRateFactor',0,'Name','binConv1')
    ...
    BinarizedtransposedConv2dLayer(3,16*netWidth,'Cropping','same','Stride',2,'BiasLearnRateFactor',0,'Name','binConv7')
    ...
    BinarizedtransposedConv2dLayer(3,8*netWidth,'Cropping','same','Stride',2,'BiasLearnRateFactor',0,'Name','binConv9')
