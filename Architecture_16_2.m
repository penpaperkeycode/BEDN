...
layers = [
    ...
    Binarizedconvolution2dLayer(3,16*netWidth,'Padding','same','Stride',1,'BiasLearnRateFactor',0,'Name','binConv15')
...
options1 = trainingOptions('adam', ...  %  sgdm,adam,rmsprop
    ...
    'LearnRateDropPeriod',420,'ExecutionEnvironment','gpu');
...
ForSegNet_tmp = trainNetwork(augimdsTrain,custom_architecture,options1);
% SyncNet8 = trainNetwork(augimdsTrain,Nettmp,options);

ForSegNet = trainNetwork(augimdsTrain,ForSegNet_tmp.Layers,options2);
