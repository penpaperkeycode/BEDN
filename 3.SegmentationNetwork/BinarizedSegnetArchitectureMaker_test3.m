function lgraph=BinarizedSegnetArchitectureMaker_test3(net,imageSize)
...
for i=2:size(net.Layers,1)
    ...
    elseif ismethod(net.Layers(i,1),'BinarizedConvolution2DLayerFixer')
        layerstmp=[layerstmp;
            ...
            'NumChannels', net.Layers(i,1).numChannels, ...
            'Padding','same', ...
            'Stride',1,'BiasLearnRateFactor',0, ...
            'Name',net.Layers(i,1).Name)
            ];
        layerstmp(end,1).Weights=net.Layers(i,1).Weights;
    else
        layerstmp=[layerstmp;net.Layers(i,1)];
    end
end
