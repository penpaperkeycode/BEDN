function lgraph=BinarizedSegnetLayers2()
% imageSize=[360 480 3];
imageSize=[240,352,3];
netWidth = 16;
layers = [
    ...
    Binarizedconvolution2dLayer(1,12*netWidth,'Padding','same','Stride',1,'BiasLearnRateFactor',0,'Name','binConv16')
    ...
    Binarizedconvolution2dLayer(1,12*netWidth,'Padding','same','Stride',1,'BiasLearnRateFactor',0,'Name','binConv18')
    batchNormalizationLayer('Name','BatchNorm18')
    SignumActivation('Sign18')
    
    maxUnpooling2dLayer('Name','UnPool2')
    
    Binarizedconvolution2dLayer(1,8*netWidth,'Padding','same','Stride',1,'BiasLearnRateFactor',0,'Name','binConv19')
    batchNormalizationLayer('Name','BatchNorm19')
    SignumActivation('Sign19')
    Binarizedconvolution2dLayer(3,8*netWidth,'Padding','same','Stride',1,'BiasLearnRateFactor',0,'Name','binConv20')
    batchNormalizationLayer('Name','BatchNorm20')
    SignumActivation('Sign20')
    Binarizedconvolution2dLayer(1,8*netWidth,'Padding','same','Stride',1,'BiasLearnRateFactor',0,'Name','binConv21')
    batchNormalizationLayer('Name','BatchNorm21')
    SignumActivation('Sign21')
    
    maxUnpooling2dLayer('Name','UnPool1')
        
    Binarizedconvolution2dLayer(3,11,'Padding','same','Stride',1,'BiasLearnRateFactor',0,'Name','binConv22')
