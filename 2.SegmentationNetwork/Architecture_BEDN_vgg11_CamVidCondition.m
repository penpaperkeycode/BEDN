...
FrontLayer = [
    ...
    BinarizedtransposedConv2dLayer(3,16*netWidth,'Cropping','same','Stride',2,'BiasLearnRateFactor',0,'Name','binConv20')
    batchNormalizationLayer('Name','BatchNorm20')
    SignumActivation('Sign20')
    Binarizedconvolution2dLayer(3,16*netWidth,'Padding','same','Stride',1,'BiasLearnRateFactor',0,'Name','binConv21')
    batchNormalizationLayer('Name','BatchNorm21')
    SignumActivation('Sign21')
    Binarizedconvolution2dLayer(3,8*netWidth,'Padding','same','Stride',1,'BiasLearnRateFactor',0,'Name','binConv22')
    batchNormalizationLayer('Name','BatchNorm22')
    SignumActivation('Sign22')
    
    BinarizedtransposedConv2dLayer(3,8*netWidth,'Cropping','same','Stride',2,'BiasLearnRateFactor',0,'Name','binConv23')
    batchNormalizationLayer('Name','BatchNorm23')
    SignumActivation('Sign23')
    Binarizedconvolution2dLayer(3,4*netWidth,'Padding','same','Stride',1,'BiasLearnRateFactor',0,'Name','binConv24')
    batchNormalizationLayer('Name','BatchNorm24')
    SignumActivation('Sign24')
    
    BinarizedtransposedConv2dLayer(3,4*netWidth,'Cropping','same','Stride',2,'BiasLearnRateFactor',0,'Name','binConv25')
    batchNormalizationLayer('Name','BatchNorm25')
    SignumActivation('Sign25')
    ];

TailLayer=[
    Binarizedconvolution2dLayer(3,numClasses,'Padding','same','Stride',1,'BiasLearnRateFactor',0,'Name','binConv26')
